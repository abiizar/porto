        ...
        <FadeIn delay={0.6} y={30} className="w-[min(72vw,360px)] sm:w-[430px] md:w-[500px] pointer-events-none">
          <div className="pointer-events-auto flex justify-center">
            <Magnet padding={150} strength={3}>
              <img src="https://shrug-person-78902957.figma.site/_components/v2/d24c01ad3a56fc65e942a1f501eb73db42d7cf9a/Rectangle_40443.81459862.png" alt="Abizar" className="w-full h-auto object-contain" />
            </Magnet>
          </div>
        </FadeIn>
      </div>
